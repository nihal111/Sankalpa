...
export function useAppState() {
  ...
  const { createTask, toggleTaskCompleted, deleteTask, duplicateTask, copyTasks, cutTasks, pasteTasks } = useTaskActions({
  ...
  const keyboardActions = useKeyboardActions({
    ...
    duplicateTask, copyTasks, cutTasks, pasteTasks, cycleSidebarNext, cycleSidebarPrev,
