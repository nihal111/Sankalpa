...
describe('buildSidebarItems', () => {
  ...
  it('includes folders and their lists when expanded', () => {
    ...
    const lists: List[] = [{ id: 'l1', name: 'Tasks', notes: null, folder_id: 'f1', sort_key: 0, created_at: 0, updated_at: 0 }];
  ...
  it('includes root-level lists', () => {
    const lists: List[] = [{ id: 'l1', name: 'Personal', notes: null, folder_id: null, sort_key: 0, created_at: 0, updated_at: 0 }];
